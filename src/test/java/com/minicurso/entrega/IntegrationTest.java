package com.minicurso.entrega;

import com.minicurso.entrega.GatewayMiniCursoApp;
import com.minicurso.entrega.config.AsyncSyncConfiguration;
...
@SpringBootTest(classes = { GatewayMiniCursoApp.class, AsyncSyncConfiguration.class })
